...
const numbersImage = Array.from({ length: 30 }, (_, index) => (index + 1).toString().padStart(2, '0'));
...
const cardImageMap = {
    "card1": { imageName: `${i1}`, folder: "imageit" },
    "card2": { imageName: `${i2}`, folder: "imageit" },
    "card3": { imageName: `${i3}`, folder: "imageit" },
    "card4": { imageName: `${i4}`, folder: "imageit" },
    "card5": { imageName: `${i5}`, folder: "imageit" },
